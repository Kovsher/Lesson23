...
public class FunctionalInterFaces {
    ...
    private static void m2() {
        ...
        System.out.println(op.apply(new StringBuilder("Functional InterFaces"), new StringBuilder("in java8")));
    ...
    private static void m3() {
        ...
        System.out.println(op.apply(new StringBuilder("Java8")));
...
class User {
    ...
    private static void sorting() {
        List<String> names = Arrays.asList("peter", "anna", "olga", "nika");
